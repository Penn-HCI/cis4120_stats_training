...
![](../images/likert_between_excel.png)

And for a **within-subjects** design:

![](../images/likert_within_excel.png)
...
For a **between-subjects** design, you can use the Wilcoxon rank sum test. See the [likert_analysis_multiple_bs.R](https://github.com/m1chaelsun/cis4120_stats_training/blob/main/likert_analysis_multiple_bs.R) page on GitHub for more information.